...
export default function Cancel() {
	return (
		<div className='cancel'>
			...
			<span className='info'>Por este medio y según los alineamientos de los derechos ARCO con los que cuenta, el usuario Rafael Nicolas Belloni Rocha solicita la cancelación en el uso de sus datos personales.</span>
